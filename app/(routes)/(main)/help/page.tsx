    ...
    <>
      <div className="flex flex-col min-h-screen">
        <div className="flex-1">
          <div className="flex mt-40 items-start justify-center text-white">
              ...
              <div className="space-y-6 text-sm">
                <div>
                  ...
                  <p>
                    ...
                    about our company or the services we provide. We&#39;ll do
                    our best to provide you with the information you need.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    Due to the virtual nature of our products/services, we do
                    not offer refunds. However, we&#39;re here to address any
                ...
                <div>
                  ...
                  <p>
                    ...
                    details about the issue you may encounter. Any information
                    you can provide will help us investigate and resolve the
                    problem.
                  </p>
                </div>
